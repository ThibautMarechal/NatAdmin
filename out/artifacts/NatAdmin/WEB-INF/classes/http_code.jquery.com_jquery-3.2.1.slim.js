...
Expr = Sizzle.selectors = {
	...
	filter: {
		...
		"PSEUDO": function( pseudo, argument ) {
			...
			// The RUser may use createPseudo to indicate that
...
//	3. Use the same single mechanism to support "private" and "RUser" data.
//	4. _Never_ expose "private" data to RUser code (TODO: Drop _data, _removeData)
//	5. Avoid exposing implementation details on RUser objects (eg. expando properties)
